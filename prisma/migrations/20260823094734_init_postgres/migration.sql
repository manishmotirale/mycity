...
-- CreateEnum
CREATE TYPE "IssueCategory" AS ENUM ('POTHOLE', 'GARBAGE', 'WATER_LEAK', 'STREETLIGHT');

-- CreateEnum
CREATE TYPE "IssueStatus" AS ENUM ('PENDING', 'VALIDATED', 'IN_PROGRESS', 'RESOLVED');

-- CreateEnum
CREATE TYPE "BadgeType" AS ENUM ('REPORTER_1', 'SUPPORTER_10', 'RESOLVER_1');
...
-- CreateIndex
CREATE UNIQUE INDEX "Badge_type_userId_key" ON "Badge"("type", "userId");
